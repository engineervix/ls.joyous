...
@register.inclusion_tag("joyous/tags/events_this_week.html", takes_context=True)
...
@register.inclusion_tag("joyous/tags/minicalendar.html", takes_context=True)
...
@register.inclusion_tag("joyous/tags/upcoming_events_detailed.html", takes_context=True)
def all_upcoming_events(context):
    """
    Displays a list of all upcoming events.
    """
    request = context["request"]
    return {"request": request, "events": getAllUpcomingEvents(request)}
...
def subsite_upcoming_events(context):
    ...
    request = context["request"]
    home = Site.find_for_request(request).root_page
    return {"request": request, "events": getAllUpcomingEvents(request, home=home)}


@register.inclusion_tag("joyous/tags/group_upcoming_events.html", takes_context=True)
...
@register.inclusion_tag("joyous/tags/future_exceptions_list.html", takes_context=True)
...
@register.inclusion_tag("joyous/tags/location_gmap.html", takes_context=True)
