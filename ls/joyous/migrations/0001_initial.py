        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "except_date",
                    models.DateField(
                        help_text="For this date", verbose_name="For Date"
                    ),
                ),
                (
                    "cancellation_title",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="multidayeventpage_events",
                        related_query_name="multidayeventpage_event",
                        to="joyous.GroupPage",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="recurringeventpage_events",
                        related_query_name="recurringeventpage_event",
                        to="joyous.GroupPage",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="simpleeventpage_events",
                        related_query_name="simpleeventpage_event",
                        to="joyous.GroupPage",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "postponement_title",
                    models.CharField(
                        help_text="The title for the postponed event",
                        max_length=255,
                        verbose_name="Title",
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="postponementpage_events",
                        related_query_name="postponementpage_event",
                        to="joyous.GroupPage",
                    ),
                ),
                (
