...
from icalendar import vDatetime, vDate, vRecur
...
class TestTimeZoneSpan(TestCase):
    ...
    def testLunchTimes(self):
        ...
        self.assertEqual(vtz["TZID"], "Pacific/Auckland")
        export = vtz.to_ical()
        # Unfold lines to be robust against different folding strategies
        export_unfolded = export.replace(b"\r\n ", b"")

        # Check key headers exist
        self.assertIn(b"BEGIN:DAYLIGHT", export)
        self.assertIn(b"DTSTART;VALUE=DATE-TIME:19951001T030000", export)
        self.assertIn(b"TZNAME:NZDT", export)
        self.assertIn(b"TZOFFSETFROM:+1200", export)
        self.assertIn(b"TZOFFSETTO:+1300", export)

        # Ensure all expected DAYLIGHT RDATE transition times are present
        daylight_rdates = [
            b"19961006T030000", b"19971005T030000", b"19981004T030000",
            b"19991003T030000", b"20001001T030000", b"20011007T030000",
            b"20021006T030000", b"20031005T030000", b"20041003T030000",
            b"20051002T030000", b"20061001T030000", b"20070930T030000",
            b"20080928T030000", b"20090927T030000", b"20100926T030000",
            b"20110925T030000", b"20120930T030000", b"20130929T030000",
            b"20140928T030000", b"20150927T030000", b"20160925T030000",
            b"20170924T030000", b"20180930T030000", b"20190929T030000",
            b"20200927T030000", b"20210926T030000", b"20220925T030000",
            b"20230924T030000", b"20240929T030000", b"20250928T030000",
            b"20260927T030000", b"20270926T030000", b"20280924T030000",
            b"20290930T030000", b"20300929T030000", b"20310928T030000",
            b"20320926T030000", b"20330925T030000", b"20340924T030000",
            b"20350930T030000", b"20360928T030000", b"20370927T030000",
        ]
        for rdate in daylight_rdates:
            self.assertIn(rdate, export_unfolded)

        # STANDARD block
        self.assertIn(b"BEGIN:STANDARD", export)
        self.assertIn(b"DTSTART;VALUE=DATE-TIME:19960317T020000", export)
        self.assertIn(b"TZNAME:NZST", export)
        self.assertIn(b"TZOFFSETFROM:+1300", export)
        self.assertIn(b"TZOFFSETTO:+1200", export)

        standard_rdates = [
            b"19970316T020000", b"19980315T020000", b"19990321T020000",
            b"20000319T020000", b"20010318T020000", b"20020317T020000",
            b"20030316T020000", b"20040321T020000", b"20050320T020000",
            b"20060319T020000", b"20070318T020000", b"20080406T020000",
            b"20090405T020000", b"20100404T020000", b"20110403T020000",
            b"20120401T020000", b"20130407T020000", b"20140406T020000",
            b"20150405T020000", b"20160403T020000", b"20170402T020000",
            b"20180401T020000", b"20190407T020000", b"20200405T020000",
            b"20210404T020000", b"20220403T020000", b"20230402T020000",
            b"20240407T020000", b"20250406T020000", b"20260405T020000",
            b"20270404T020000", b"20280402T020000", b"20290401T020000",
            b"20300407T020000", b"20310406T020000", b"20320404T020000",
            b"20330403T020000", b"20340402T020000", b"20350401T020000",
            b"20360406T020000", b"20370405T020000",
        ]
        for rdate in standard_rdates:
            self.assertIn(rdate, export_unfolded)
...
class TestVEventFactory(TestCase):
    ...
    def testUnsupportedPageType(self):
        ...
        with self.assertRaises(CalendarTypeError) as expected:
            vev = self.factory.makeFromPage(page, None)  # noqa: F841
